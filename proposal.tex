...
For the first iteration of the project, we are looking for the ability to simulate a room/environment along with the sound waves from the source, and how they interact with the environment and how they are interpreted by an observer. We will have a fixeds source and observer along with a fixed viewpoint of the scene.
